...
#
# Created: Tue May 17 22:18:23 2016
...
class Ui_MainApp(object):
    def setupUi(self, MainApp):
        ...
        self.rb_file = QtGui.QRadioButton(self.groupBox)
        self.rb_file.setChecked(True)
        self.rb_file.setObjectName(_fromUtf8("rb_file"))
        self.horizontalLayout_6.addWidget(self.rb_file)
        self.rb_directory = QtGui.QRadioButton(self.groupBox)
        ...
        self.gridLayout_17.addWidget(self.labelLoading, 4, 0, 1, 1)
        ...
        self.gridLayout_17.addLayout(self.horizontalLayout_2, 5, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 409, 252))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 391, 158))
